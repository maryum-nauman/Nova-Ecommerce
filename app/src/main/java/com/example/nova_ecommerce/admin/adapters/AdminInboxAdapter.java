...
public class AdminInboxAdapter extends RecyclerView.Adapter<AdminInboxAdapter.InboxViewHolder> {
    ...
    public AdminInboxAdapter(Context context, List<ChatPreview> chatList, OnChatClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull InboxViewHolder holder, int position) {
        ...
        String name = chat.getUserName() != null ? chat.getUserName() : "?";
    ...
    static class InboxViewHolder extends RecyclerView.ViewHolder {
        TextView tvAvatar, tvUserName, tvLastMessage, tvTime, tvUnread;
